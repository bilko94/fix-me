    ...
    private void sendPackets(){
        ...
        for (packet scheduledPacket: packets){
            ...
            if (!scheduledPacket.isValid())
                ...
                writeToSocketChannel(sender.channel, new packet("cannot find " + scheduledPacket.recipient + ": (" + scheduledPacket.packetToString().replace(";","_") + ")" ,1,sender.id).packetToString());
